...
(() => {
  ...
  class LinacConsole {
    constructor({ scenario, file, cfg }) {
      ...
      this.fields = Array.isArray(scenario?.treatmentFields) ? scenario.treatmentFields : [];
    ...
    _renderTables() {
      ...
      // Geometry table
      const planGantry = Number(field.gantryAngle ?? 0);
      ...
      const geomRows = [];
      geomRows.push(["Gantry Rtn", format1(planGantry), format1(planGantry)]);
