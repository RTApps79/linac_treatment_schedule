...
(function () {
  // Normalize scenario paths so schedule entries can be simple file names
  // (e.g., "A0_computer_withErrors.json") while still resolving correctly.
  //
  // Repo convention: scenario JSON lives under ./data/
